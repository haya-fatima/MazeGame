...
set_property PACKAGE_PIN R18 [get_ports btn1]
set_property PACKAGE_PIN L17 [get_ports btn2]
set_property PACKAGE_PIN P17 [get_ports btn3]
set_property PACKAGE_PIN M19 [get_ports btn4]
set_property PACKAGE_PIN P18 [get_ports btn5]
...
set_property IOSTANDARD LVCMOS33 [get_ports count_x]
set_property IOSTANDARD LVCMOS33 [get_ports count_y]
